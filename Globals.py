...
# caseBundle_persBind is a vector bundle of all brain trio_Vectors in the memory (i.e. Person x Word 1 x Word 2)
# caseBunle_persBundle is a vector bundle of all brain pair_Vectors in memory without a Person bind attached (i.e. Word 1 x Word 2)
# caseBundle_smBundle is a vector bundle of all social media pair_vectors in memory without a Person or media object attached (i.e. word 1 x word 2)
